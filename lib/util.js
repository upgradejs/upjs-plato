...
function getLockFilesExistence(projectRootPath) {
	return {
		packageLockExist: fs.existsSync(path.resolve(projectRootPath, 'package-lock.json')),
		yarnLockExist: fs.existsSync(path.resolve(projectRootPath, 'yarn.lock'))
	};
}
...
exports.getLockFilesExistence = getLockFilesExistence;
